...
\part{Dokumentation}
\input{documentation/1-einleitung.tex}
\input{documentation/2-grundlagen.tex}
\input{documentation/3-konfiguration.tex}
\input{documentation/4-implementierung.tex}
\input{documentation/5-erweiterungsmoeglichkeiten.tex}
\input{documentation/6-zusammenfassung.tex}
